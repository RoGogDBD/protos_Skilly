 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.auth.CreateAppRequest,
 *   !proto.auth.CreateAppResponse>}
 */
const methodDescriptor_Auth_CreateApp = new grpc.web.MethodDescriptor(
  '/auth.Auth/CreateApp',
  grpc.web.MethodType.UNARY,
  proto.auth.CreateAppRequest,
  proto.auth.CreateAppResponse,
  /**
   * @param {!proto.auth.CreateAppRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.auth.CreateAppResponse.deserializeBinary
);


/**
 * @param {!proto.auth.CreateAppRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.auth.CreateAppResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.auth.CreateAppResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.auth.AuthClient.prototype.createApp =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/auth.Auth/CreateApp',
      request,
      metadata || {},
      methodDescriptor_Auth_CreateApp,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.auth.CreateAppResponse>}
 *     Promise that resolves to the response
 */
proto.auth.AuthPromiseClient.prototype.createApp =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/auth.Auth/CreateApp',
      request,
